...
ax1 = fig.add_axes([0.15, 0.1, 0.8, 0.35])
ax2 = fig.add_axes([0.15, 0.55, 0.38, 0.35])
ax3 = fig.add_axes([0.57, 0.55, 0.38, 0.35])

ax1.set_xlim(0, 20)
ax1.set_xlabel('$t_{enshr}$ (Myr)')
ax1.set_ylabel('PDF')
ax1.set_xticks(np.linspace(0, 20, num=11))
ax_plot(True, ax1,Fesc_new8, read_new_01Zsun,150,480,20,False,True, 'k','G9_Zlow','solid',False)
ax_plot(True, ax1,Fesc_new8, read_new_01Zsun_05pc,70,380,20,False,True, 'lightseagreen','G9_Zlow_HR','dashed',False)
plot(ax2,ax3,read_new_01Zsun,'k','G9_Zlow','solid',331)
plot(ax2,ax3,read_new_01Zsun_05pc,'lightseagreen','G9_Zlow_HR','dashed',231)

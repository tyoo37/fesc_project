...
fesc_rel(ax66,ax6, read_new_01Zsun_05pc, 150, 380, Fesc_new, 'G9_Zlow_HR',True)
#fesc_rel(ax55,ax5, read_new_1Zsun, 150, 480, Fesc_new8,  'G9_Zhigh',True)
fesc_rel(ax44,ax4, read_new_1Zsun_highSN_new, 70, 380, Fesc_new8,  'G9_Zhigh_SN5',True)
fesc_rel(ax55,ax5, read_new_03Zsun_highSN, 70, 380, Fesc_new8,  'G9_Zmid_SN5',True)
...
print(0.008/0.27)
plt.savefig('/Volumes/THYoo/kisti/plot/2019thesis/fig11_thesis2.pdf')

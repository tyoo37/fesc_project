...
def KS(ax,read, Part1, Cell1, saveload,label,color,diskmass,nout):
    ...
    if saveload==False:
        ...
        for i in range(len(rgrid)-1):
            ...
            sd = np.sum(Cell1.mH2[indcell])/area #solar mass/pc^2
...
def main(ax, read, Cell,label,color, saveload, noutdirect,diskmass):
    ...
    KS(ax,read, Part1,Cell1,saveload,label,color,diskmass,nout)
...
gauss_cont(ax2, '/Users/taehwau/projects/KS/bigiel10_inner.fit', '/Users/taehwau/projects/KS/bigiel10_outer.fit',8,6)
...
scatter_kennicutt(ax2,'/Users/taehwau/projects/KS/kennicutt07_total.fit',4,'grey',0,2,'x', 'Kennicutt+07 (M51)')
...
main(ax2,read_new_01Zsun,Cell,'G9_Zlow','k',False,300,1.75e9)
main(ax2, read_new_1Zsun, Cell,'G9_Zhigh','firebrick',False,300,1.75e9)
main(ax2,read_new_gasrich,Cellfromdat,'G9_Zlow_gas5','dodgerblue',False,300,1.75e9*5)
main(ax2,read_new_1Zsun_highSN_new,Cellfromdat,'G9_Zhigh_SN5','magenta',False,220,1.75e9)
main(ax2,read_new_03Zsun_highSN,Cellfromdat,'G9_Zmid_SN5','orange',False,220,1.75e9)
main(ax2,read_new_01Zsun_05pc,Cellfromdat,'G9_Zlow_HR','lightseagreen',False,220,1.75e9)

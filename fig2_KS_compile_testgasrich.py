...
ax2=fig.add_axes([0.15,0.1,0.8,0.38])
ax1=fig.add_axes([0.15,0.6,0.8,0.38])
...
for i in range(100):
    if i ==300:
        main(ax1,ax2,read_new_gasrich,Cellfromdat,'G9_Zlow_gas5','r',False,200+i)

    else:
        main(ax1,ax2,read_new_gasrich,Cellfromdat,'G9_Zlow_gas5','dodgerblue',False,200+i)

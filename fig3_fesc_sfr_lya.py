...
read_new_01Zsun_lyaoff = '/Volumes/gdrive/0.1Zsun_lyaoff/'
read_new_01Zsun_lyaoff_highSN = '/Volumes/gdrive/0.1Zsun_lyaoff_SNen/'
...
ax1 = fig.add_axes([0.13, 0.08, 0.35, 0.19])
ax2 = fig.add_axes([0.52, 0.08, 0.35, 0.19])
ax3 = fig.add_axes([0.13, 0.31, 0.35, 0.19])
ax4 = fig.add_axes([0.52, 0.31, 0.35, 0.19])
ax5 = fig.add_axes([0.13, 0.54, 0.35, 0.19])
ax6 = fig.add_axes([0.52, 0.54, 0.35, 0.19])
ax7 = fig.add_axes([0.13, 0.77, 0.35, 0.19])
ax8 = fig.add_axes([0.52, 0.77, 0.35, 0.19])
...
fescplot(ax5, ax55, Part, Fesc_new8, read_new_01Zsun, 2, 480, 'G9_Zlow',True, 'dodgerblue','r',True,True)
...
fescplot(ax1, ax11, Part, Fesc_new8, read_new_1Zsun_highSN_new, 2,380,  'G9_Zhigh_SN5',True,'dodgerblue', 'r',  True, False)
fescplot(ax4, ax44, Part, Fesc_new8, read_new_03Zsun_highSN, 2,380, 'G9_Zmid_SN5',True,'dodgerblue', 'r',  True, False)
fescplot(ax6, ax66, Part, Fesc_new8, read_new_01Zsun_05pc, 2,380, 'G9_Zlow_HR',True,'dodgerblue', 'r',  True, False)
fescplot(ax3, ax33, Part, Fesc_new8, read_new_gasrich, 2, 300, 'G9_Zlow_gas5',True,'dodgerblue', 'r',  True, False)
fescplot(ax2, ax22, Part, Fesc_new8, read_new_1Zsun, 2, 483, 'G9_Zhigh',True,'dodgerblue', 'r',  True, False)

fescplot(ax7, ax77, Part, Fesc_new8, read_new_01Zsun_lyaoff, 2, 480, 'G9_Zlow_Nolya',True, 'dodgerblue','r',True,False)
fescplot(ax8, ax88, Part, Fesc_new8, read_new_01Zsun_lyaoff_highSN, 2, 480, 'G9_Zlow_Nolya_SN5',True, 'dodgerblue','r',True,False)
...
ax77.yaxis.set_major_formatter(plt.NullFormatter())
...
#plt.show()
plt.savefig('/Volumes/THYoo/kisti/plot/2019thesis/fesc_SFR_fig3.pdf')

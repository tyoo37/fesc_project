...
def temp_check(dir, inisnap, endsnap, Fesc):
    ...
    for n in range(numsnap):
        ...
        if dir==read_new_03Zsun_highSN and nout==312:
            continue
        if not os.path.isfile(dir + '/SAVE/part_%05d.sav' % (nout)):
            print('there is no ' + dir + '/SAVE/part_%05d.sav' % (nout))
            nosnap.append(nout)
...
ax_plot(True, ax1,ax3,ax2,Fesc_new8, read_new_01Zsun,164,380,20,False,True, 'grey','G9_01Zsun','dashed',False)
ax_plot(False, ax1,ax3,ax2,Fesc_new8, read_new_gasrich,164,290,20,False,True, 'b','G9_01Zsun_gasrich','dashed',False)

ax_plot(True, ax1,ax3,ax2,Fesc_new8,read_new_03Zsun_highSN,195,371,20,False,True,'orange','G9_03Zsun_SNboost','solid',False)
ax_plot(True, ax1,ax3,ax2,Fesc_new8, read_new_1Zsun_highSN_new,190,374,20,False,True,'red','G9_1Zsun_SNboost','solid',False)

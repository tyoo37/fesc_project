...
fig = plt.figure(figsize=(7, 10), dpi=144)

ax2 = fig.add_axes([0.17, 0.4, 0.66, 0.17])
ax4 = fig.add_axes([0.17, 0.6, 0.66, 0.17])
ax6 = fig.add_axes([0.17, 0.8, 0.66, 0.17])

ax7 = fig.add_axes([0.17,0.15, 0.66,0.15])


def fescplot(ax, ax2, Part, Fesc, dir, inisnap, endsnap, label, load, color, color2, text, legend, plot):
    if load == False:
    ...
    if plot==True:
        ...
        pp3 = ax.plot(timearray[index2], fescarray2[index2], color='brown', ls='dotted', lw=3,
                      label=r'$\langle f_{esc}\rangle$ w/o dust')
...
ax44=ax4.twinx()
ax66=ax6.twinx()
fesc1,med1, upp1, low1 = fescplot(ax2, ax22, Part, Fesc_new8, read_new_01Zsun, 2, 480, 'G9_Zlow',True, 'dodgerblue','r',True,True,False)
...
fesc2,med2, upp2, low2 =fescplot(ax2, ax22, Part, Fesc_new8, read_new_1Zsun_highSN_new, 2,380,  'G9_Zhigh_SN5',True,'dodgerblue', 'r',  True, False,True)
fesc3,med3, upp3, low3 =fescplot(ax4, ax44, Part, Fesc_new8, read_new_03Zsun_highSN, 2,380, 'G9_Zmid_SN5',True,'dodgerblue', 'r',  True, False,True)

fesc4,med4, upp4, low4 =fescplot(ax6, ax66, Part, Fesc_new, read_new_01Zsun_05pc, 2,380, 'G9_Zlow_HR',True,'dodgerblue', 'r',  True, False,True)
fesc5,med5, upp5, low5=fescplot(ax2, ax22, Part, Fesc_new8, read_new_gasrich, 2, 300, 'G9_Zlow_gas5',True,'dodgerblue', 'r',  True, False,False)
fesc6,med6, upp6, low6=fescplot(ax2, ax22, Part, Fesc_new8, read_new_1Zsun, 2, 480, 'G9_Zhigh',True,'dodgerblue', 'r',  True, False,False)
...
ax2.set_xlabel('time (Myr)',fontsize=23)
#ax1.set_ylabel(r'$\langle f_{esc} \rangle$')
ax4.set_ylabel('$f_{esc}^{3D}$',fontsize=28)
...
ax7.set_xticklabels(barx2,rotation=40,fontsize=15,ha='right')
...
ax7.set_ylim(1e-3, 0.5)
ax7.set_xlim(0.5,6.5)
ax7.set_xticks([1,2,3,4,5,6])
plt.tick_params(axis='y',which='minor')

plt.savefig('/Volumes/THYoo/kisti/plot/2019thesis/fesc_SFR_fig3_thesis2.pdf')
